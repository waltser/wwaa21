		...
		?>
				<?php if (have_rows('fruit')) : ?>
					<?php while (have_rows('fruit')) : the_row();
						...
						<div id="woman" class="hello <?php the_field('coming_soon'); ?>">
							...
							<?php if (get_field('coming_soon') == 'coming_soon') : ?>
								...
								<?php elseif (get_field('coming_soon') == 'insta') : ?>
									...
									<?php elseif (get_field('coming_soon') == 'partners') : ?>
									<a class="modal-link" href="https://21.womenwhoadvance.eu/partners/">

									<?php elseif (get_field('coming_soon') == 'about') : ?>
									<a class="modal-link" href="https://21.womenwhoadvance.eu/about/">
									
										<?php else : ?>
											<a class="modal-link" href="<?php echo esc_url(get_permalink()); ?>">
											<?php endif; ?>
